...
class BusRoutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bus_route" do
    assert_difference('BusRoute.count') do
      post bus_routes_url, params: { bus_route: { description: @bus_route.description, image_url: @bus_route.image_url, name: @bus_route.name } }
    end
  ...
  test "should update bus_route" do
    patch bus_route_url(@bus_route), params: { bus_route: { description: @bus_route.description, image_url: @bus_route.image_url, name: @bus_route.name } }
